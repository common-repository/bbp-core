  ...
  class CSF_Field_icon extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'button_title' => esc_html__( 'Add Icon', 'bbp-core' ),
        'remove_title' => esc_html__( 'Remove Icon', 'bbp-core' ),
      ) );
          ...
          <div class="csf-modal-table-cell">
            ...
            <div class="csf-modal-inner">
              <div class="csf-modal-title">
                <?php esc_html_e( 'Add Icon', 'bbp-core' ); ?>
                <div class="csf-modal-close csf-icon-close"></div>
              </div>
              <div class="csf-modal-header">
                <input type="text" placeholder="<?php esc_html_e( 'Search...', 'bbp-core' ); ?>" class="csf-icon-search" />
              </div>
