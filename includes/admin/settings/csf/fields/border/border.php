  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'bbp-core' ),
        'right_placeholder'  => esc_html__( 'right', 'bbp-core' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'bbp-core' ),
        'left_placeholder'   => esc_html__( 'left', 'bbp-core' ),
        'all_placeholder'    => esc_html__( 'all', 'bbp-core' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'bbp-core' ),
        'dashed'    => esc_html__( 'Dashed', 'bbp-core' ),
        'dotted'    => esc_html__( 'Dotted', 'bbp-core' ),
        'double'    => esc_html__( 'Double', 'bbp-core' ),
        'inset'     => esc_html__( 'Inset', 'bbp-core' ),
        'outset'    => esc_html__( 'Outset', 'bbp-core' ),
        'groove'    => esc_html__( 'Groove', 'bbp-core' ),
        'ridge'     => esc_html__( 'ridge', 'bbp-core' ),
