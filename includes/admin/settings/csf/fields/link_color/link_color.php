...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'bbp-core' ),
        'hover'    => esc_html__( 'Hover', 'bbp-core' ),
        'active'   => esc_html__( 'Active', 'bbp-core' ),
        'visited'  => esc_html__( 'Visited', 'bbp-core' ),
        'focus'    => esc_html__( 'Focus', 'bbp-core' )
      );
