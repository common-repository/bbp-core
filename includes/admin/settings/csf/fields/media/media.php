  ...
  class CSF_Field_media extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'preview_height' => '',
        'library'        => array(),
        'button_title'   => esc_html__( 'Upload', 'bbp-core' ),
        'remove_title'   => esc_html__( 'Remove', 'bbp-core' ),
      ...
      $placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="'.  esc_html__( 'Not selected', 'bbp-core' ) .'"' : '';
