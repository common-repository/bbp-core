      ...
      echo '<div class="csf--typography'. esc_attr( $chosen_class ) .'" data-depend-id="'. esc_attr( $this->field['id'] ) .'" data-unit="'. esc_attr( $args['unit'] ) .'" data-line-height-unit="'. esc_attr( $line_height_unit ) .'" data-exclude="'. esc_attr( $args['exclude'] ) .'">';
        ...
        echo '<div class="csf--blocks csf--blocks-selects">';
          ...
          if ( ! empty( $args['font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Family', 'bbp-core' ) .'</div>';
            echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'bbp-core' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['backup_font_family'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Backup Font Family', 'bbp-core' ) .'</div>';
            echo $this->create_select( apply_filters( 'csf_field_typography_backup_font_family', array(
              ...
              'Georgia, serif',
              'Palatino Linotype'
            ) ), 'backup-font-family', esc_html__( 'Default', 'bbp-core' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Font Style', 'bbp-core') .'</div>';
            echo '<select class="csf--font-style-select" data-placeholder="Default">';
            echo '<option value="">'. ( ! $this->chosen ? esc_html__( 'Default', 'bbp-core' ) : '' ) .'</option>';
            ...
            if ( ! empty( $args['extra_styles'] ) ) {
              ...
              echo ( ! $this->chosen ) ? '<div class="csf--title">'. esc_html__( 'Load Extra Styles', 'bbp-core' ) .'</div>' : '';
              $placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'bbp-core' ) : esc_html__( 'Default', 'bbp-core' );
          ...
          if ( ! empty( $args['subset'] ) ) {
            ...
            echo '<div class="csf--title">'. esc_html__( 'Subset', 'bbp-core' ) .'</div>';
            $subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
            echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'bbp-core' ), $args['multi_subset'] );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_align'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Align', 'bbp-core' ) .'</div>';
            echo $this->create_select( array(
              'inherit' => esc_html__( 'Inherit', 'bbp-core' ),
              'left'    => esc_html__( 'Left', 'bbp-core' ),
              'center'  => esc_html__( 'Center', 'bbp-core' ),
              'right'   => esc_html__( 'Right', 'bbp-core' ),
              'justify' => esc_html__( 'Justify', 'bbp-core' ),
              'initial' => esc_html__( 'Initial', 'bbp-core' )
            ), 'text-align', esc_html__( 'Default', 'bbp-core' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['font_variant'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Variant', 'bbp-core' ) .'</div>';
            echo $this->create_select( array(
              'normal'         => esc_html__( 'Normal', 'bbp-core' ),
              'small-caps'     => esc_html__( 'Small Caps', 'bbp-core' ),
              'all-small-caps' => esc_html__( 'All Small Caps', 'bbp-core' )
            ), 'font-variant', esc_html__( 'Default', 'bbp-core' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_transform'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Transform', 'bbp-core' ) .'</div>';
            echo $this->create_select( array(
              'none'       => esc_html__( 'None', 'bbp-core' ),
              'capitalize' => esc_html__( 'Capitalize', 'bbp-core' ),
              'uppercase'  => esc_html__( 'Uppercase', 'bbp-core' ),
              'lowercase'  => esc_html__( 'Lowercase', 'bbp-core' )
            ), 'text-transform', esc_html__( 'Default', 'bbp-core' ) );
            echo '</div>';
          }
          ...
          if ( ! empty( $args['text_decoration'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Text Decoration', 'bbp-core' ) .'</div>';
            echo $this->create_select( array(
              'none'               => esc_html__( 'None', 'bbp-core' ),
              'underline'          => esc_html__( 'Solid', 'bbp-core' ),
              'underline double'   => esc_html__( 'Double', 'bbp-core' ),
              'underline dotted'   => esc_html__( 'Dotted', 'bbp-core' ),
              'underline dashed'   => esc_html__( 'Dashed', 'bbp-core' ),
              'underline wavy'     => esc_html__( 'Wavy', 'bbp-core' ),
              'underline overline' => esc_html__( 'Overline', 'bbp-core' ),
              'line-through'       => esc_html__( 'Line-through', 'bbp-core' )
            ), 'text-decoration', esc_html__( 'Default', 'bbp-core' ) );
            echo '</div>';
          }
        ...
        echo '<div class="csf--blocks csf--blocks-inputs">';
          ...
          if ( ! empty( $args['font_size'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Font Size', 'bbp-core' ) .'</div>';
          ...
          if ( ! empty( $args['line_height'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Line Height', 'bbp-core' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['letter_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Letter Spacing', 'bbp-core' ) .'</div>';
            echo '<div class="csf--input-wrap">';
          ...
          if ( ! empty( $args['word_spacing'] ) ) {
            echo '<div class="csf--block">';
            echo '<div class="csf--title">'. esc_html__( 'Word Spacing', 'bbp-core' ) .'</div>';
            echo '<div class="csf--input-wrap">';
        ...
        if ( ! empty( $args['color'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Font Color', 'bbp-core' ) .'</div>';
        ...
        if ( ! empty( $args['custom_style'] ) ) {
          ...
          echo '<div class="csf--title">'. esc_html__( 'Custom Style', 'bbp-core' ) .'</div>';
      ...
      if ( ! wp_script_is( 'csf-webfontloader' ) ) {
        ...
        if ( ! empty( $customwebfonts ) ) {
          $webfonts['custom'] = array(
            'label' => esc_html__( 'Custom Web Fonts', 'bbp-core' ),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__( 'Safe Web Fonts', 'bbp-core' ),
        ...
        $webfonts['google'] = array(
          'label' => esc_html__( 'Google Web Fonts', 'bbp-core' ),
